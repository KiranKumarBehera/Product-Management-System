...
import com.miniproject.productmgmtsys.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<Product> saveAllProduct(List<Product> productList) {
		return productList.stream().map(subsReqModel->saveProduct(subsReqModel)).collect(Collectors.toList());
	}
